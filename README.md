...
| Raw Diffraction averaged over a full rotation through angle φ|  Color inversed and thresholded (lines included to visually represent 34&deg;) | Franklin's Photograph (Fiber dia. ~20μm, A-Form (dry) ) | Franklin's Photograph 51 (Fiber dia. ~50μm, B-Form (wet) )
:--------------------:|:--------------------:|:-------------------:|:-------------------:
