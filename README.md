...
Franklin's experiment did not measure one single DNA twist, she instead was beaming fibres of DNA hung vertically, and bunched together in spools of micron-sized scale, while sampling using high energy Xrays. The result of her experiment then more accurately reflects, again, the congregate diffraction of many strands of DNA. To simulate this, we can simulate diffraction over many units of DNA, however this leads to time being the limiting factor. We unfortunately cannot employ the same filtering techniques as with simpler crystals, as the diffraction structure is more dyanmic in shape. However, by recognizing Franklins experiment is agnostic to DNA's rotation around the axis from which it is suspended, we can instead use a spacial average to help aleviate some of crsytal-edge effects. By running the simulation over 36 equally spaced rotations of the crystal along the major axis of the DNA and averaging the results (and filtering out noise caused from the simulation), we can obtain a diffraction image presented below, as well as a thresholded image with the colors inversed to accurately match real world photographic plates "negative is positive" appearance.

| Raw Diffraction averaged over a full rotation through angle φ|  Color inversed and thresholded (lines included to visually represent 34&deg;) | Franklin's Photograph (Fiber dia. ~20μm ) | Franklin's Photograph 51 (Fiber dia. ~50μm )
:--------------------:|:--------------------:|:-------------------:|:-------------------:
![BDNADiffraction](https://github.com/michaelLukasik/EigenLaueDiffraction_Working/assets/138163589/3ff4b6f4-a1db-4364-add7-a433381ef2e5) | ![BDNAThresh](https://github.com/michaelLukasik/EigenLaueDiffraction_Working/assets/138163589/8e57c6bc-c39f-48dd-bfa0-aeace0b3a553)|![FranklinN51](https://github.com/michaelLukasik/EigenLaueDiffraction_Working/assets/138163589/0b6fd775-7378-4eb2-9a94-f71f1a1c0f58)|![p51](https://github.com/michaelLukasik/EigenLaueDiffraction_Working/assets/138163589/e73dabcc-625c-486b-84f3-622609806fdf)


Comparison between the simulation results and Franklin's experiment shows the incrase in diffraction structure complexity with a decrease of fiber size. The simulated crystal shows heavy banding immediately in the viscinity of the axis of the beam, wehere as Franklin's experiments show this banding being suppressed as the DNA fiber spools get thicker. Some structures, such as the 34&deg tilt to the "X" structure within the diffraction pattern (corresponding to the fractional pitch per base pair of the DNA strand), as well as the increasingly spaced and feint banding structure radiating from the center of the pattern. At this resolution and scale, the missing 4th band cannot clearly be made out via threshholding, however there is a decrease of intensity at a radius corresponding to the 4th band.
